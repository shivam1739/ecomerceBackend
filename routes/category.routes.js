...
const routes = (app) => {
    ...
    app.post('/ecomm/api/v1/categories', CategoryMiddelware.validateCreate,AuthenticationMiddelware.isAuthenticated, CategoryController.createCategory);
    ...
    app.put('/ecomm/api/v1/categories/:id',CategoryMiddelware.validateCreate,AuthenticationMiddelware.isAuthenticated, CategoryController.updateCategory);

    /* to delete a category by id*/
    app.delete('/ecomm/api/v1/categories/:id',CategoryMiddelware.validateCreate,AuthenticationMiddelware.isAuthenticated, CategoryController.deleteCategory)
